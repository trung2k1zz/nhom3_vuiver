...
<div class="container h-600 w-100 border">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
       ...
       <div class="col-xs-3 col-sm-3 col-md-3  col-lg-3 "> 
        <div style="position: relative;background: url(img/ql.jpg); width:100%; height:150px;background-repeat:round">
            <p style="position: absolute;top:2.3em; right: -0.6em; width: 100%; height:35px; padding: 4px;font-weight: bold; font-size: 25px;">
                   <r><a href="QuanLyThongTinTruong.php?Ma=<?php echo $_GET['Ma'];?>">Quản Lý Info Trường</a>
    	...
    	<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 h-150">
            ...
            <p style="position: absolute;top:2.3em; right: -1.2em; width: 100%; height:35px; padding: 4px;font-weight: bold; font-size: 25px;">
                   <r><a href="TimKiemDanhSachLop.php?Ma=<?php echo $_GET['Ma'];?>">TK Danh Sách Lớp</a>
                   </r>
                    <?php
						//Viết tiếp Code
				    ?>
